...
void TBackgroundModel::ProfileNLL(int fParFixed)
{
  ...
  {
    // if (i == 0)continue;
    fInitValues.push_back(fParameters[fParFixed] + fParError[fParFixed]/50*i );
    cout << "Input initial value: " << fParameters[fParFixed] + fParError[fParFixed]/50*i << endl;
  }
