...
void FitThPeaks(TH1D *dHisto, bool bSavePlots = false)
{
    ...
    fFitDE->SetParameters(500, 1581, 3., 1000, 1590, 3., 0., 0.);
...
void FitRaPeaks(TH1D *dHisto, bool bSavePlots = false)
{
    ...
    fFitPb1->SetParameters(10000., 241.997, 2.8, 0., 0.);

    TF1 *fFitPb2 = new TF1("fFitPb2", "gaus(0) + pol1(3)", dFitMinPb2, dFitMaxPb2);
    fFitPb2->SetParameters(10000., 295.224, 2.8, 0., 0.);

    TF1 *fFitPb3 = new TF1("fFitPb3", "gaus(0) + pol1(3)", dFitMinPb3, dFitMaxPb3);
    fFitPb3->SetParameters(10000., 351.932, 2.8, 0., 0.);
...
void DrawMC(int dMult = 1, bool bSavePlots = false)
{
    ...
    outTree50mK->Add(Form("/Users/brian/macros/Simulations/Bkg/50mK-Ra226-B-M%d-T50-r0.0425.root", dMult));
    outTree50mK->Project("h50mK","Ener1");


    TChain *outTree600mK = new TChain("outTree");
    outTree600mK->Add(Form("/Users/brian/macros/Simulations/Bkg/600mK-Ra226-B-M%d-T50-r0.0425.root", dMult));
...
*/
    ...
    outTreeIVC->Add(Form("/Users/brian/macros/Simulations/Bkg/IVC-Ra226-B-M%d-T50-r0.0425.root", dMult));
    outTreeIVC->Project("hIVC","Ener1");

    TChain *outTreeOVC = new TChain("outTree");
    outTreeOVC->Add(Form("/Users/brian/macros/Simulations/Bkg/OVC-Ra226-B-M%d-T50-r0.0425.root", dMult));
