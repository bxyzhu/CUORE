...
class TBkgModelSource : public TObject {

public:
	// Default Constructor
	TBkgModelSource();

	// Constructor, takes in input files
	TBkgModelSource(double fFitMin, double fFitMax, int fBinBase, int fDataSet);

	virtual ~TBkgModelSource();

	// Adaptive binning, with respect to data
...
private:
	...
	ClassDef(TBkgModelSource, 1)
};

#endif // __TBkgModelSource__
