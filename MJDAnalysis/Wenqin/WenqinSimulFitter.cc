...
WenqinSimulFitter::WenqinSimulFitter() : 
    fFitMin(2.), 
    fFitMax(100.), 
    fEnergy(nullptr), 
    fRealData(nullptr),
...
void WenqinSimulFitter::ConstructPDF()
{
...
void WenqinSimulFitter::DoFit(std::string Minimizer)
{
...
void WenqinSimulFitter::DrawBasicShit(double binSize)
{
...
void WenqinSimulFitter::DrawContour(std::string argN1, std::string argN2)
{
...
void WenqinSimulFitter::GenerateMCStudy(std::string argN, int nMC)
{
...
void WenqinSimulFitter::GenerateToyMC(std::string fileName)
{
...
double WenqinSimulFitter::GetSigma(double energy)
{
...
// Load data from file
void WenqinSimulFitter::LoadData(std::string fileName, std::string treeName, std::string parName)
{
...
void WenqinSimulFitter::LoadChainData(TChain *skimTree, std::string theCut)
{
...
void WenqinSimulFitter::ProfileNLL(std::string argN)
{
...
void WenqinSimulFitter::SaveShit(std::string outfileName)
{
...
void WenqinSimulFitter::SetFitRange(double fitMin, double fitMax)
{
    fFitMin = fitMin;
    fFitMax = fitMax;
}
